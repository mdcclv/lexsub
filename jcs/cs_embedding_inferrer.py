...
Used in the paper:
A Simple Word Embedding Model for Lexical Substitution. Workshop on Vector
Space Modeling for NLP (VSM), 2015 (VSM 2015)
'''
    ...
    def represent(self, target, deps, avg_flag, tfo):
        ...
        for dep in deps:
            if dep in self.context_vecs:
                ...
                tfo.write(
                    "NOTICE: %s not in context embeddings. Ignoring.\n" % dep)
